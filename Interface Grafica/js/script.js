...
function showMore(){
	...
	$("#mostrar_distro").click(function(){
		ajaxRequest("consulta_distro.php", $("#distro"), "POST");
	});
...
function showLess(){
	...
	$("#mostrar_menos_distro").click(function(){
		ajaxRequest("consulta_distro.php", $("#distro"), "GET");
	});
...
function searchTables(){
	searchByTable($(".usuario"), $(".usuario_search"));
 	searchByTable($(".distro"), $(".distro_search"));
